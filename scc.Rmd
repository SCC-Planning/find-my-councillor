...
division_popup2 <- sprintf(
  "<strong>%s</strong><br/><strong><a href = %s>%s</a></strong><br/><strong><span style='color:%s;'>%s</span></strong><br/><img src=%s width = 240px/><br/><br><strong><a href = %s>%s</a></strong><br/><strong><span style='color:%s;'>%s</span></strong><br/><img src=%s width = 240px/>",
